...
func (gi *GitIgnore) MatchesPath(f string, multi bool) bool {
	if multi {
		match, _ := gi.MatchesPathHow2(f)
		return match
	}
	matchesPath, _ := gi.MatchesPathHow(f)
	return matchesPath
}
func (gi *GitIgnore) MatchesPathHow2(f string) (bool, *IgnorePattern) {
